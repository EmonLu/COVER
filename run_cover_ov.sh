...
LOG_FILE="evaluation_log_ov.txt"
...
for video_file in "$video_folder"/*.mp4; do
    ...
    CMD="python  evaluate_one_video_ov.py -v $video_file"
...
for video_file in "$video_folder"/*.mp4; do
    ...
    CMD="numactl -C 0-15 python  evaluate_one_video_ov.py -v $video_file"
...
for video_file in "$video_folder"/*.mp4; do
    ...
    CMD="numactl -C 0-23 python  evaluate_one_video_ov.py -v $video_file"
